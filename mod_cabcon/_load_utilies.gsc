...
runMenuIndex( menu )
{
    ...
    self addMenuPar("Credits", ::controlMenu, "newMenu", "main_credits");
	...
	{
		self addmenu("main_powerups", "Power-Up Options", "main");
		self addMenuPar("Nuke Bomb", ::func_call_powerups, "nuke");
		self addMenuPar("Ammo Box", ::func_call_powerups, "full_ammo");
		self addMenuPar("Double Points", ::func_call_powerups, "double_points");
		self addMenuPar("Insta Kill", ::func_call_powerups, "insta_kill");
		self addMenuPar("Carpenter", ::func_call_powerups, "carpenter");
		self addMenuPar("Fire Sale", ::func_call_powerups, "fire_sale");
		self addMenuPar("Bonfire Sale", ::func_call_powerups, "bonfire_sale");
		self addMenuPar("Minigun", ::func_call_powerups, "minigun");
		self addMenuPar("Free Perk", ::func_call_powerups, "free_perk");
		self addMenuPar("All Revive", ::func_call_powerups, "all_revive");
		self addMenuPar("Tesla", ::func_call_powerups, "tesla");
		self addMenuPar("Bonus Points", ::func_call_powerups, "bonus_points_player");
		self addMenuPar("Bonus Points Team", ::func_call_powerups, "bonus_points_team");
	}
			
	func_create_entity_menu();
	
	
	self addmenu("main_aimbot", "Aimbot Options", "main");
	self addMenuPar("Toggle Aimbot", ::func_aimbot_classic);
	self addMenuPar("Toggle Unfair Aimbot", ::func_aimbot_setting_unfair);
	self addMenuPar("Toggle Auto Shoot", ::func_aimbot_setting_auto_shoot);
	...
	self addmenu("main_entity", "Entity Options", "main");
	...
	////////////////////////
	self addmenu("main_visions", "Visions Options", "main");
	...
	self addmenu("main_sounds", "SFX Options", "main");
	...
	self addmenu("main_teleport", "Teleport Options", "main");
	...
	self addmenu("main_fun", "Fun Options", "main");
	...
	self addMenuPar("Modded Tracer", ::func_moddedtracer);
	self addMenuPar("Auto Tbag", ::func_autotbag);
	self addMenuPar("Flashing Player", ::func_flashingPlayer);
	self addMenuPar("Jet Pack", ::func_doJetPack);
	self addMenuPar("Ice Skater", ::func_IceSkater);
	...
	self addMenuPar("Aquatic Screen", ::quick_modificator, "r_waterSheetingFX_enable", 1, 0);
	self addMenuPar("Healthshield", ::func_healthShield);
	...
	if(isDefined(level._effect["thundergun_smoke_cloud"]))self addMenuPar("Dead Ghost Smoke", ::Toogler_FX_System, "thundergun_smoke_cloud");
	if(isDefined(level._effect["def_explosion"]))self addMenuPar("Explosion Man ", ::Toogler_FX_System, "def_explosion");
	if(isDefined(level._effect["rise_burst_water"]))self addMenuPar("Killing Water", ::Toogler_FX_System, "rise_burst_water");
	if(isDefined(level._effect["lightning_dog_spawn"]))self addMenuPar("Lightning Strike", ::Toogler_FX_System, "lightning_dog_spawn");
	if(isDefined(level._effect["fx_zombie_mainframe_beam"]))self addMenuPar("Light Strike", ::Toogler_FX_System, "fx_zombie_mainframe_beam");
	if(isDefined(level._effect["poltergeist"]))self addMenuPar("Poltergeist", ::Toogler_FX_System, "poltergeist");
	...
	self addMenuPar("Modified by @a5x", ::headline);
	
	self addmenu("main_bullets", "Bullets Options", "main");
	self addMenuPar("Modded Bullets ^1OFF", ::func_toggle_modded_bullets);
	...
	*/
	...
	self addmenu("main_round", "Server Options", "main");
	self addMenuPar("Modify Round", ::controlMenu, "newMenu", "main_round_modify");
	self addMenuPar("Server Tweakables", ::controlMenu, "newMenu", "main_round_tweakables");
    self addMenuPar("Earthquake", ::func_earthquake);
	
	self addmenu("main_round_tweakables", "Server Tweakables", "main_round");
	self addMenuPar("Show List", ::quick_modificator, "ui_showList", 1, 0);
	self addMenuPar("Display FbColorTable", ::quick_modificator, "r_showFbColorDebug", 1, 0);
    self addMenuPar("Display DoF Informations", ::quick_modificator, "r_dof_showdebug", 1, 0);
    self addMenuPar("Display Sky Informations", ::quick_modificator, "r_sky_intensity_showDebugDisplay", 1, 0);
	self addMenuPar("Cursor Hints", ::quick_modificator, "cg_cursorHints", 0, 4);
    self addMenuPar("Cursor Hints Types", ::quick_modificator, "cg_cursorHints", 1, 2, 4);
	self addMenuPar("Super Speed", ::quick_modificator,"g_speed",500,999,190);
	self addMenuPar("Super Speed Bar", ::EditorDvarCabCon, 1000,1,"g_speed",10,190);
	self addMenuPar("Super Jump", ::quick_modificator,"jump_height",500,1000,39);
	self addMenuPar("Super Jump Bar", ::EditorDvarCabCon, 1000,1,"jump_height",10,39);
	self addMenuPar("Super Gravity", ::quick_modificator, "bg_gravity", 400,100,800);
	self addMenuPar("Super Gravity Bar", ::EditorDvarCabCon, 1200,1,"bg_gravity",10,800);
	self addMenuPar("Super Physical Gravity", ::quick_modificator, "phys_gravity", 50,0,-800);
	self addMenuPar("Super Physical Gravity Bar", ::EditorDvarCabCon, 1000,-1000,"phys_gravity",10,-800);
	self addMenuPar("Timescale", ::quick_modificator, "timescale", 2,.5,1);
	self addMenuPar("Timescale Bar", ::EditorDvarCabCon, 10,.1,"timescale",.1,1);
    self addMenuPar("Friendlyfire", ::quick_modificator, "scr_friendlyfire", 1, 0);
    self addMenuPar("Entity Collision", ::quick_modificator, "phys_entityCollision", 0, 1);
    self addMenuPar("Disable every trap", ::func_trapdisable);
    self addMenuPar("Trap Actvity Time", ::func_TrapTimeTrap);
    self addMenuPar("Trap Cololdwon Time", ::func_colldownToggleTrap);
	
	self addmenu("main_round_modify", "Modify Round", "main_round");
    ...
    self addMenuPar("- 5 Rounds",::func_roundsystem, -5, false);
    self addMenuPar("+ 1 Rounds",::func_roundsystem, 1, false);
    
    
	//self addMenuPar("Drop Current Weapon",::func_dropWeapon);
	
	self addmenu("main_weapons_mods_viewmodel_pos", "Viewmodel/Weapon Position", "main_weapons");
	...
	self addMenuPar("Default All Viewmodel/Weapon Positions",::def_call_main_weapons_mods_viewmodel_pos);
	...
	self addmenu("main_weapons_mods_flashlight", "Flashlight Menu", "main_weapons");
	...
	*/
	...
	self addmenu("main_weapons_mods_pp", "Packer Punch Options", "main_weapons");
	...
	*/
	...
	self addMenuPar("Give All Perks", ::give_all_perks);
	...
	*/
	...
	self addmenu("main_messages", "Server Messages", "main");
	self addMenuPar("Revolution Reborn", ::func_callMessage, "^3Revolution Reborn for BO1^7");
    self addMenuPar("Creator", ::func_callMessage, "^4a5x!");
    self addMenuPar("Creator Social", ::func_callMessage, "^1Check this out github.com/a5x/");
    self addMenuPar("Updates", ::func_callMessage, "Updates on github.com/a5x/BO1-Zombies-Mod-Menu-PS4/");
	self addHeadline("Menu Informations");
	self addMenuPar("Menu Version", ::func_callMessage, "LAST UPDATE: ^3"+self.menu["version"]);
...
self addmenu("main_weapons", "Weapons Options", "main");
	self addMenuPar("Stock Weapons", ::controlMenu, "newMenu", "main_weapons_stock");
	self addMenuPar("Upgraded Weapons", ::controlMenu, "newMenu", "main_weapons_upgraded");
	...
	self addMenuPar("Viewmodel/Weapon Position", ::controlMenu, "newMenu", "main_weapons_mods_viewmodel_pos");
	self addMenuPar("Take Current Weapon", ::func_takeWeapon);
	self buildWeaponMenuPages();
...
initializeWeaponMenuLabels()
{
    if( !isDefined( self.weapon_menu_labels ) )
        self.weapon_menu_labels = [];

    self.weapon_menu_labels["m1911_zm"] = "M1911";
    self.weapon_menu_labels["python_zm"] = "PYTHON";
    self.weapon_menu_labels["cz75_zm"] = "CZ75";
    self.weapon_menu_labels["ak74u_zm"] = "AK74U";
    self.weapon_menu_labels["mp5k_zm"] = "MP5K";
    self.weapon_menu_labels["mp40_zm"] = "MP40";
    self.weapon_menu_labels["mpl_zm"] = "MPL";
    self.weapon_menu_labels["pm63_zm"] = "PM63";
    self.weapon_menu_labels["spectre_zm"] = "SPECTRE";
    self.weapon_menu_labels["cz75dw_zm"] = "CZ75DW";
    self.weapon_menu_labels["ithaca_zm"] = "ITHACA";
    self.weapon_menu_labels["spas_zm"] = "SPAS";
    self.weapon_menu_labels["rottweil72_zm"] = "ROTTWEIL72";
    self.weapon_menu_labels["hs10_zm"] = "HS10";
    self.weapon_menu_labels["m14_zm"] = "M14";
    self.weapon_menu_labels["m16_zm"] = "M16";
    self.weapon_menu_labels["g11_lps_zm"] = "G11";
    self.weapon_menu_labels["famas_zm"] = "FAMAS";
    self.weapon_menu_labels["aug_acog_zm"] = "AUG";
    self.weapon_menu_labels["galil_zm"] = "GALIL";
    self.weapon_menu_labels["commando_zm"] = "COMMANDO";
    self.weapon_menu_labels["fnfal_zm"] = "FNFAL";
    self.weapon_menu_labels["dragunov_zm"] = "DRAGUNOV";
    self.weapon_menu_labels["l96a1_zm"] = "L96A1";
    self.weapon_menu_labels["rpk_zm"] = "RPK";
    self.weapon_menu_labels["hk21_zm"] = "HK21";
    self.weapon_menu_labels["m72_law_zm"] = "M72 LAW";
    self.weapon_menu_labels["china_lake_zm"] = "CHINA LAKE";
    self.weapon_menu_labels["ray_gun_zm"] = "RAY GUN";
    self.weapon_menu_labels["tesla_gun_zm"] = "TESLA GUN";
    self.weapon_menu_labels["thundergun_zm"] = "THUNDERGUN";
    self.weapon_menu_labels["crossbow_explosive_zm"] = "CROSSBOW";
    self.weapon_menu_labels["knife_ballistic_zm"] = "BALLISTIC KNIFE";
    self.weapon_menu_labels["knife_ballistic_bowie_zm"] = "BOWIE KNIFE";
    self.weapon_menu_labels["knife_ballistic_sickle_zm"] = "SICKLE KNIFE";
    self.weapon_menu_labels["freezegun_zm"] = "FREEZEGUN";
    self.weapon_menu_labels["claymore_zm"] = "CLAYMORE";
    self.weapon_menu_labels["frag_grenade_zm"] = "GRENADE FRAG";
    self.weapon_menu_labels["zombie_cymbal_monkey"] = "MONEY CYMBAL";

    self.weapon_menu_labels["m1911_upgraded_zm"] = "M1911 UPGRADED";
    self.weapon_menu_labels["python_upgraded_zm"] = "PYTHON UPGRADED";
    self.weapon_menu_labels["cz75_upgraded_zm"] = "CZ75 UPGRADED";
    self.weapon_menu_labels["ak74u_upgraded_zm"] = "AK74U UPGRADED";
    self.weapon_menu_labels["mp5k_upgraded_zm"] = "MP5K UPGRADED";
    self.weapon_menu_labels["mp40_upgraded_zm"] = "MP40 UPGRADED";
    self.weapon_menu_labels["mpl_upgraded_zm"] = "MPL UPGRADED";
    self.weapon_menu_labels["pm63_upgraded_zm"] = "PM63 UPGRADED";
    self.weapon_menu_labels["spectre_upgraded_zm"] = "SPECTRE UPGRADED";
    self.weapon_menu_labels["cz75dw_upgraded_zm"] = "CZ75DW UPGRADED";
    self.weapon_menu_labels["ithaca_upgraded_zm"] = "ITHACA UPGRADED";
    self.weapon_menu_labels["spas_upgraded_zm"] = "SPAS UPGRADED";
    self.weapon_menu_labels["rottweil72_upgraded_zm"] = "ROTTWEIL72 UPGRADED";
    self.weapon_menu_labels["hs10_upgraded_zm"] = "HS10 UPGRADED";
    self.weapon_menu_labels["m14_upgraded_zm"] = "M14 UPGRADED";
    self.weapon_menu_labels["m16_gl_upgraded_zm"] = "M16 UPGRADED";
    self.weapon_menu_labels["g11_lps_upgraded_zm"] = "G11 UPGRADED";
    self.weapon_menu_labels["famas_upgraded_zm"] = "FAMAS UPGRADED";
    self.weapon_menu_labels["aug_acog_mk_upgraded_zm"] = "AUG UPGRADED";
    self.weapon_menu_labels["galil_upgraded_zm"] = "GALIL UPGRADED";
    self.weapon_menu_labels["commando_upgraded_zm"] = "COMMANDO UPGRADED";
    self.weapon_menu_labels["fnfal_upgraded_zm"] = "FNFAL UPGRADED";
    self.weapon_menu_labels["dragunov_upgraded_zm"] = "DRAGUNOV UPGRADED";
    self.weapon_menu_labels["l96a1_upgraded_zm"] = "L96A1 UPGRADED";
    self.weapon_menu_labels["rpk_upgraded_zm"] = "RPK UPGRADED";
    self.weapon_menu_labels["hk21_upgraded_zm"] = "HK21 UPGRADED";
    self.weapon_menu_labels["m72_law_upgraded_zm"] = "M72 LAW UPGRADED";
    self.weapon_menu_labels["china_lake_upgraded_zm"] = "CHINA LAKE UPGRADED";
    self.weapon_menu_labels["ray_gun_upgraded_zm"] = "RAY GUN UPGRADED";
    self.weapon_menu_labels["tesla_gun_upgraded_zm"] = "TESLA GUN UPGRADED";
    self.weapon_menu_labels["thundergun_upgraded_zm"] = "THUNDERGUN UPGRADED";
    self.weapon_menu_labels["crossbow_explosive_upgraded_zm"] = "CROSSBOW UPGRADED";
    self.weapon_menu_labels["knife_ballistic_upgraded_zm"] = "BALLISTIC KNIFE UPGRADED";
    self.weapon_menu_labels["knife_ballistic_bowie_upgraded_zm"] = "BOWIE KNIFE UPGRADED";
    self.weapon_menu_labels["knife_ballistic_sickle_upgraded_zm"] = "SICKLE KNIFE UPGRADED";
    self.weapon_menu_labels["freezegun_upgraded_zm"] = "FREEZEGUN UPGRADED";
    self.weapon_menu_labels["claymore_upgraded_zm"] = "CLAYMORE UPGRADED";
    self.weapon_menu_labels["frag_grenade_upgraded_zm"] = "GRENADE FRAG UPGRADED";
    self.weapon_menu_labels["zombie_cymbal_monkey_upgraded_zm"] = "MONEY CYMBAL UPGRADED";
}

getWeaponMenuDisplayName( weapon_name )
{
    if( !isDefined( weapon_name ) || weapon_name == "" )
        return "";

    if( !isDefined( self.weapon_menu_labels ) )
        self initializeWeaponMenuLabels();

    if( isDefined( self.weapon_menu_labels[weapon_name] ) )
        return self.weapon_menu_labels[weapon_name];

    return weapon_name;
}

buildWeaponMenuPages()
{
    self initializeWeaponMenuLabels();

    self addmenu("main_weapons_stock", "Stock Weapons", "main_weapons");
    stock_weapons = GetArrayKeys( level.zombie_include_weapons );
    for( i = 0; i < stock_weapons.size; i++ )
    {
        weapon_name = stock_weapons[i];
        if( IsSubStr( ToLower( weapon_name ), "upgraded" ) )
            continue;
        self addMenuPar( self getWeaponMenuDisplayName( weapon_name ), maps\_zombiemode_weapons::weapon_give, weapon_name );
    }

    self addmenu("main_weapons_upgraded", "Upgraded Weapons", "main_weapons");
    upgraded_keys = GetArrayKeys( level.zombie_weapons );
    for( i = 0; i < upgraded_keys.size; i++ )
    {
        base_weapon = upgraded_keys[i];
        if( !IsDefined( level.zombie_weapons[base_weapon].upgrade_name ) )
            continue;

        upgraded_weapon = level.zombie_weapons[base_weapon].upgrade_name;
        if( !IsSubStr( ToLower( upgraded_weapon ), "upgraded" ) )
            continue;

        self addMenuPar( self getWeaponMenuDisplayName( upgraded_weapon ), maps\_zombiemode_weapons::weapon_give, upgraded_weapon );
    }
}
